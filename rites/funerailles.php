...
class Rituel 
{
    ...
    function __construct() {
        $this->type = "Funérailles" ;
    }

    function questionnaire() {
        $output = '<h2>Construction des Funérailles</h2><div class="questions"><form method="POST"><fieldset>
            <legend>Général</legend>
            <div><label for="defunt">Défunt(e) : </label>
            <input name="defunt" id="defunt" type="text">
